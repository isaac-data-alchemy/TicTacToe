...
class Session:
    ...
    def display_scores(self) -> None:
        ...
        # Player 1
        print(
            f"👤 {self.game.leaderboards.p1:<20} Wins: {self.game.leaderboards.p1_wins:>3} | Losses: {self.game.leaderboards.p1_loss:>3}"
        )

        # Player 2 stats
        print(
            f"👤 {self.game.leaderboards.p2:<20} Wins: {self.game.leaderboards.p2_wins:>3} | Losses: {self.game.leaderboards.p2_loss:>3}"
        )
